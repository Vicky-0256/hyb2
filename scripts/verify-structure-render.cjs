...
assert.match(cplfoldSetup, /href="\.\/local-cplfold\.html"[^>]*target="_blank"/);
assert.doesNotMatch(cplfoldSetup, /python3\.11 -m venv \.venv-cplfold/);
assert.doesNotMatch(cplfoldSetup, /HYB2_CPLFOLD_MAX_NT=2000/);
