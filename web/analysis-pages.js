(function () {
  ...
  function renderStructurePreparation(sequenceInfo, structure) {
    ...
    const localCplfoldInput = structure && structure.engine === "cplfold"
      ? '<button class="button button-secondary" type="button" data-feature-action="download-local-cplfold-input" aria-label="Download prepared sequence for local bin/cplfold" title="Download prepared sequence for local bin/cplfold">Download local input</button>'
      : "";
    return [
