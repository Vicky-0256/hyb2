...
- **External assets:** none. The application deliberately loads no third-party images, fonts, scripts, analytics, or CDN resources.
...
- GitHub Pages deployment uses a static artifact workflow; no back-end, analytics, CDN, or third-party runtime is required.
